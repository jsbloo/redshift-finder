...
const PassportModal = ({id}) => {
    ...
    const getPassport = async () => {
        const citizenID = await axios.get(`http://18.132.193.129:3002/person2citizen/getById/${id}`);
        const passportID = await axios.get(`http://18.132.193.129:3002/citizen2passport/getById/${citizenID.data.citizenId}`);
        const passport = await axios.get(`http://18.132.193.129:3002/passport/getById/${passportID.data.passportId}`);
